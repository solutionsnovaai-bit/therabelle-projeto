...
export const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      'Agente de IA no WhatsApp/Instagram para triagem de leads',
    ],
    highlight: true,
  },
  {
    ...
    period: '/ mês',
    description: 'Tudo do plano Presença, com um painel próprio de comando pra clínica.',
    features: [
      'Tudo do plano Presença',
      'Dashboard exclusivo com calendário e métricas de alcance/engajamento',
      'Assistente de IA personalizada para dúvidas e apoio no dia a dia',
      'Automações de atendimento sob medida para a clínica',
    ],
    highlight: false,
  },
]
